...
require_once('class.constants.php');
	...
	define("EZSQL_DB_USER", CONST_DB_USER);			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", CONST_DB_PASSWORD);		// <-- mysql db password
	define("EZSQL_DB_NAME", CONST_DB_NAME);		// <-- mysql db pname
	define("EZSQL_DB_HOST", CONST_DB_HOST);	// <-- mysql server host
